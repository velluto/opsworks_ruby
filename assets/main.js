...
CodeFlask.prototype.handleInput = function(textarea, highlightCode, highlightPre) {
    ...
    textarea.addEventListener('keydown', function(e) {
        ...
        // If TAB pressed, insert two spaces
        if(e.keyCode === 9){
...
/* global CodeFlask, Clipboard, BASE_URL */
...
( function( $ ) {
  ...
  var FormBuilder = {
    ...
    build: function() {
      var group, field, currentGroup, method;
        ...
        if ( this.schema.hasOwnProperty( group ) ) {
          ...
          for ( field in this.schema[ group ] ) {
            if ( this.schema[ group ].hasOwnProperty( field ) ) {
              method = "build" + this.schema[ group ][ field ].type[ 0 ].toUpperCase() +
                this.schema[ group ][ field ].type.substring( 1 );
              this[ method ]( group, field );
            }
          }
        }
      }
    ...
    buildHeader: function( value ) {
      ...
      if ( value === "database" || value === "scm" ) {
        head += "<div class=\"bs-callout bs-callout-danger\"><h4>This group works out of the box</h4>" +
          "<p>If you configured your " + value + " in OpsWorks, you don't have to change anything here. " +
          "Refer <a href=\"https://github.com/ajgon/opsworks_ruby\">documentation</a> for more details.</p></div>";
      }
    ...
    buildBoolean: function( group, field ) {
      ...
      var node = $(
        "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field + "\">" +
          field + "</label> <div class=\"col-sm-7\"><input type=\"checkbox\" data-type=\"boolean\" name=\"" + group +
          "." + field + "\" id=\"" + group + "_" + field  + "\"> " +
          "<p class=\"help-block\">" + item.description + this.seeMore( item ) + "</p></div></div>"
      );
    ...
    buildFloat: function( group, field ) {
      ...
      var node = $(
        "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field + "\">" +
          field + "</label> <div class=\"col-sm-7\"><input type=\"number\" data-type=\"float\" step=\"0.1\" name=\"" +
          group + "." + field + "\" class=\"form-control\" id=\"" + group + "_" + field + "\"> " +
          "<p class=\"help-block\">" + item.description + this.seeMore( item ) + "</p></div></div>"
      );
      this.container.append( node );
      var self = this;
      node.find( "input" ).change( function( e ) {
        self.onTextChange.call( this, e, "float" );
      } );
    },
    buildInteger: function( group, field ) {
      ...
      var node = $(
        "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field + "\">" +
          field + "</label> <div class=\"col-sm-7\"><input type=\"number\" data-type=\"integer\" step=\"1\" name=\"" +
          group + "." + field + "\" class=\"form-control\" id=\"" + group + "_" + field + "\"> " +
          "<p class=\"help-block\">" + item.description + this.seeMore( item ) + "</p></div></div>"
      );
      this.container.append( node );
      var self = this;
      node.find( "input" ).change( function( e ) {
        self.onTextChange.call( this, e, "integer" );
      } );
    },
    buildString: function( group, field ) {
      ...
      if ( item.values ) {
        nodeData = "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field +
          "\">" + field + "</label> <div class=\"col-sm-7\"><select data-type=\"string\" name=\"" + group + "." +
          field + "\" class=\"form-control\" id=\"" + group + "_" + field + "\">";
        ...
        node = $(
          "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field + "\">" +
            field + "</label> <div class=\"col-sm-7\"><input type=\"text\" data-type=\"string\" name=\"" + group + "." +
            field + "\" class=\"form-control\" id=\"" + group + "_" + field + "\"> " +
            "<p class=\"help-block\">" + item.description + this.seeMore( item ) + "</p></div></div>"
      );
      }
    ...
    buildText: function( group, field, type ) {
      ...
      var node = $(
        "<div class=\"form-group\"><label class=\"col-sm-5 control-label\" for=\"" + group + "_" + field + "\">" +
          field + "</label> <div class=\"col-sm-7\"><textarea data-type=\"" + item.type + "\" name=\"" + group + "." +
          field + "\" class=\"form-control\" id=\"" + group + "_" + field + "\"></textarea> " +
          "<p class=\"help-block\">" + item.description + this.seeMore( item ) + "</p></div></div>"
      );
      var nodeType = type || "text";
      this.container.append( node );
      var self = this;
      node.find( "textarea" ).change( function( e ) {
        self.onTextChange.call( this, e, nodeType );
      } );
    },
  ...
  var JSONBuilder = {
    ...
    init: function( schema ) {
      ...
      $( ".CodeFlask__textarea" ).change( function() {
      ...
      new Clipboard( "#code-ctrl-c", {
        target: function() {
          return $( ".CodeFlask__textarea" )[ 0 ];
        }
      } );
    },
    ...
    build: function( data ) {
      ...
      for ( key in data ) {
        if ( data.hasOwnProperty( key ) ) {
          ...
          if (
            !this.schema[ pair[ 0 ] ] ||
            !this.schema[ pair[ 0 ] ][ pair[ 1 ] ] ||
            ( this.schema[ pair[ 0 ] ][ pair[ 1 ] ].default !== data[ key ] &&
